...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('', '', formRef.current, '') // Correct formRef usage
          .then(
            () => {
